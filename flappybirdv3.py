...
def draw_screen(screen, birds, pipes, base, score, gen, highscroe, p_vel, bird_count, p_height, DEAD):
...
def test_best_genome(config_path, genome_path='FlappyAI\w_1.pkl'):
    DEAD = False
